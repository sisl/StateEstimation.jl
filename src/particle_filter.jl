...
# ╔═╡ d6d9c76e-e254-491a-8c5a-dafef6c015ca
...
function particle_filter(𝐬::Matrix, 𝒫::POMDP, a, o)
	(T, O) = (𝒫.T, 𝒫.O)
	𝐬′ = mapslices(s->rand(T(s, a)), 𝐬; dims=1)
...
with_terminal() do
	@testset begin
		...
		global a = 1e-10
		for i in 1:t
			(belief, s, a, o) = step(𝒫, belief, 𝒜, s, a, o, T, observation)
...
with_terminal() do
	...
	for i in 1:t2
		(belief2, s2, a2, o2) = step(𝒫2, belief2, 𝒜2, s2, a2, o2, T2, observation2)
	end
	@show s2
end
...
# ╔═╡ 10c90a46-5bc0-41db-8882-5fd8f0025a41
show_gif()
