...
# ╔═╡ 48e842a9-9162-49c0-8c12-8ce0da1c2265
...
# ╔═╡ 3a8fe8ae-3657-4ea0-a185-d9c71ecf3379
function plot_belief(b)
	plot(size=(600,300), ylabel=raw"$b(s)$")
	bar!([raw"$p($hungry$)$", raw"$p($sated$)$"], b,
		 lab=false, ylims=(0,1.05), c=:lightgray,
		 bar_width=0.5, ratio=1)
end

# ╔═╡ 6530b119-d048-49e7-a056-005ec61b02d8
plot_belief(b₀)

# ╔═╡ 8bc7f1f5-ac10-4fdd-a00d-11ad64ea1007
plot_belief(b₁)

# ╔═╡ 9d454ffc-d8a4-4ecf-8a44-321876b37ccf
plot_belief(b₂)

# ╔═╡ 65510a08-dc07-4bc1-9615-5e695eb3a259
plot_belief(b₃)

# ╔═╡ f4834b04-c9f1-49ab-9164-1eee514bd791
plot_belief(b₄)

# ╔═╡ cf232df0-b0a4-424a-84f7-094967f4955d
plot_belief(b₅)
